...
<bean:size id="kinmuJissekiNyuryokuKakuninListSize"
	name="kinmuJissekiNyuryokuKakuninForm"
	property="kinmuJissekiNyuryokuKakuninList" />
<html>
<head>
...
<script type="text/javascript" language="Javascript1.1">
	...
	function regist() {
		// 一覧のサイズ
		var listSize =
<%=kinmuJissekiNyuryokuKakuninListSize%>
	;
		// 開始時間エラーメッセージ
		var startTimeErrMsg = '';
		// 終了時間エラーメッセージ
...
<body>
			...
			<div id="gymBody">
				<html:form action="/shainMstMntRegist">
					<div style="float: left; width: 100%;">
						<div
							style="float: left; width: 804px; text-align: left; margin-left: 100px;">
							表示年月：
					...
					<div style="width: 1088px; margin-left: 100px;">
						<table class="tblHeader" border="1" cellpadding="0"
							cellspacing="0">
							<tr>
								<td width="50px" align="center">日付</td>
								<td width="30px" align="center">曜</td>
								<td width="50px" align="center">シフト</td>
								...
								<td width="320px" align="center">備考</td>
							</tr>
						</table>
					</div>
					<!-- 票のずれをwidhtで修正　有吉 -->
					<div
						style="overflow: auto; height: 400px; width: 1090px; margin-left: 100px;">
 ...
 %> <bean:write
									...
									<td width="100px" align="center"><html:text
											style="text-align:center" size="9" maxlength="5"
									...
									<td width="100px" align="center">
										<!--propertyをjikangaiTime→jitsudouTimeへ変更　西 --> <bean:write
											name="kinmuJissekiNyuryokuKakuninList"
											property="jitsudouTime" /><br>
									</td>
									...
									<td width="320px" align="left"><html:text
