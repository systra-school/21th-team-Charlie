				...
				<table width="90%">
					<tr>
						<td id="headLeft"><input value="戻る" type="button"
							class="smlButton"
							onclick="doSubmit('/kikin_test/kinmuJissekiKakuninBack.do')" />
						</td>
						<td id="headCenter">勤務実績確認</td>
						<td id="headRight">
							<!-- 修正＆追加 村瀬 inputタグをコメントアウト＆htmlタグを追加 --> <!--<html:form action="/logout">
             		 <input type="submit" value="ログアウト" class="smlButton" />
            	</html:form> --> <!-- 修正＆追加 西　htmlタグをコメントアウトinputタグ記載に修正 -->
							<input value="ログアウト" type="button" class="smlButton"
							onclick="doSubmit('/kikin_test/logout.do')" /> <!--<input value="ログアウト" type="button" class="smlButton" onclick="logout()" />-->
						</td>
					</tr>
				</table>
			</div>
