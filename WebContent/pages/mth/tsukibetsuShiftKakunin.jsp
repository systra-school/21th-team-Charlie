	...
	<bean:size id="dateBeanListSize" name="tsukibetsuShiftKakuninForm"
		property="dateBeanList" />
	<bean:size id="listSize" name="tsukibetsuShiftKakuninForm"
		property="tsukibetsuShiftKakuninBeanList" />
	<bean:define id="showLength" value="17" type="java.lang.String" />
	<bean:define id="offset" name="tsukibetsuShiftKakuninForm"
		property="offset" />
	<bean:define id="color" value="" type="java.lang.String" />
	<bean:define id="cntPage" name="tsukibetsuShiftKakuninForm"
		property="cntPage" type="java.lang.Integer" />
	<bean:define id="maxPage" name="tsukibetsuShiftKakuninForm"
	...
	<!-- 修正＆追加 伊藤　height: 470px;からheight: 530px;に修正 -->
							...
							<div
								...
								<table class="tblHeader" border="1" cellpadding="0"
									...
									<tr height="<%=heightSize%>px">
										...
										<!-- 17行目まで表示されていたものを15行目まで表示するようshowlengthからlength=15へ変更　伊藤 -->
									</tr>
									<logic:iterate offset="offset" length="<%=showLength%>"
										id="tsukibetsuShiftKakuninBeanList"
										name="tsukibetsuShiftKakuninForm"
