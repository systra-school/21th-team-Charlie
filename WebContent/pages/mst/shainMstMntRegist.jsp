				...
				<table>
					<tr>
						<td id="headLeft"><input value="戻る" type="button"
							class="smlButton"
							onclick="doSubmit('/kikin_test/shainMstMntRegistBack.do')" /></td>
				...
				<html:form action="/shainMstMntRegist">
					<div style="width: 650px; text-align: left; margin-left: 300px;">
						<table class="tblHeader" border="1" cellpadding="0"
							cellspacing="0">
							<tr>
								<td width="150px" align="center">パスワード</td>
					...
					<div
						style="overflow: auto; height: 440px; width: 650px; margin-left: 300px;">
						<table class="tblBody" border="1" cellpadding="0" cellspacing="0">
							<tr>
								<td width="150px" align="center"><html:text
										property="password" value="" size="10" /></td>
								<td width="200px" align="center"><html:text
										property="shainName" value="" size="20" /></td>
								<td width="200px" align="center"><html:text
										property="shainNameKana" value="" size="20" /></td>
