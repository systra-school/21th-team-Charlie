		...
		<div id="wrapper">
				...
				<table>
					<tr>
						<td id="headLeft"><input value="戻る" type="button"
							class="smlButton"
							onclick="doSubmit('/kikin_test/shainMstMntBack.do')" /></td>
			...
			<div id="gymBody">
				<html:form action="/shainMstMntUpdate">
					...
					<div
						style="overflow: auto; height: 440px; width: 1030px; margin-left: 100px">
							...
							<logic:iterate indexId="idx" id="shainMstMntBeanList"
								...
								<tr>
									<td width="200px" align="center"><bean:write
											property="shainId" name="shainMstMntBeanList" /> <html:hidden
											property="shainId" name="shainMstMntBeanList" indexed="true" />
									</td>
									<td width="200px" align="center"><html:password
											property="password" name="shainMstMntBeanList" size="10"
											maxlength="6" indexed="true" /></td>
									<td width="200px" align="center"><html:text
											property="shainName" name="shainMstMntBeanList" size="20"
											maxlength="10" indexed="true" /></td>
									<td width="200px" align="center"><html:text
											property="shainNameKana" name="shainMstMntBeanList" size="20"
											maxlength="10" indexed="true" /></td>
									<td width="100px" align="center"><html:select
											property="kengenId" name="shainMstMntBeanList"
									...
									<td width="100px" align="center"><html:checkbox
										...
										<html:hidden property="deleteFlg" name="shainMstMntBeanList"
