		...
		<div id="wrapper">
			...
			<div id="gymBody">
				<html:form>
					<%-- 凡例 --%>
					<div id="hanrei"
						style="width: 470px; margin-left: 15px; float: left">
						<div>
						...
						<div style="height: 450px; overflow: auto">
							<table class="tblBody" border="1" cellpadding="0" cellspacing="0">
								<logic:iterate id="shiftHanreiBeanList" name="shiftHanreiForm"
									property="shiftHanreiBeanList" indexId="idx">
									<tr>
										<td width="100px" align="center"><bean:write
												property="shiftName" name="shiftHanreiBeanList" /></td>
										<td width="150px" align="center"><bean:write
												property="symbol" name="shiftHanreiBeanList" /></td>
										<td width="150px" align="center"><bean:write
												property="timeZone" name="shiftHanreiBeanList"
												filter="false" /></td>
										<td width="50px" align="center"><bean:write
												property="kyukei" name="shiftHanreiBeanList" /></td>
									</tr>
								</logic:iterate>
							</table>
						</div>
